...
urlpatterns = [
    ...
    path('transactions-details/',aurora_views.transactions_details,name="transactions-details"),
    ...
    path('ecom-product-grid/',aurora_views.ecom_product_grid,name="ecom-product-grid"),
    path('ecom-product-list/',aurora_views.ecom_product_list,name="ecom-product-list"),
    path('ecom-product-detail/',aurora_views.ecom_product_detail,name="ecom-product-detail"),
    path('ecom-product-order/',aurora_views.ecom_product_order,name="ecom-product-order"),
    ...
    path('form-validation-jquery/',aurora_views.form_validation_jquery,name="form-validation-jquery"),

    path('table-bootstrap-basic/',aurora_views.table_bootstrap_basic,name="table-bootstrap-basic"),
    path('table-datatable-basic/',aurora_views.table_datatable_basic,name="table-datatable-basic"),

    path('page-login/',aurora_views.page_login,name="page-login"),
    path('page-register/',aurora_views.page_register,name="page-register"),
    path('page-forgot-password/',aurora_views.page_forgot_password,name="page-forgot-password"),
