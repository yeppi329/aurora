...
def svc_activity_user(request):
    ...
    for data in all_data:
        print(f'Summary ID: {data.summary_id}, Date: {data.summary_dt}, use_day_7: {data.use_day_7}')
...
def scan_status_daily(request):
    ...
    for data in all_data:
        print(f'Summary ID: {data.summary_id}, Date: {data.summary_dt}, scan_success: {data.scan_success}')
